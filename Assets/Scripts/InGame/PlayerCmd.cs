...
public class PlayerCmd : MonoBehaviour
{
    ...
    public void ClickOnTestSpellCard(BaseEventData t_event)//relates to CloseTestSpellCard()
    {
        ...
        {
            Gateway.raiseCertainEvent(Gateway.SpellCardCode(), new object[] { Gateway.GetPlayerSequenceByName(PhotonNetwork.LocalPlayer.NickName), -2, -1, 6 });//6 means 试探卡牌, -2 means Peek card
        }
    }
